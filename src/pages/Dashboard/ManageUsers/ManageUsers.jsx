...
const ManageUsers = () => {
    ...
    const handleMakeInstructor = (user) => {
        ...
        fetch(`https://instru-play-server-mehedihasan-ofc.vercel.app/users/instructor/${user._id}`, {
            method: 'PATCH'
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handleMakeAdmin = (user) => {
        fetch(`https://instru-play-server-mehedihasan-ofc.vercel.app/users/admin/${user._id}`, {
            method: 'PATCH'
        })
            .then(res => res.json())
            .then(data => {
